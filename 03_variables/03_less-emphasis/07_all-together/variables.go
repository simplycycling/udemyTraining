...
var a = "this string stored in the variable a" // package scope
var b, c string = "stored in b", "stored in c" // package scope
var d string                                   // package scope, declaration

func main() {

	d = "stored in d" // declaration above, assignment here, package scope
	var e = 42        // function scope - subsequent vars have same package scope
	f := 43
	g := "stored in g"
